...
export const makeUniversalApp = async (opts) => {
    ...
    try {
        ...
        if (x64AsarMode === AsarMode.HAS_ASAR) {
            ...
            const x64AsarSha = await sha((_a = opts.x64AsarPath) !== null && _a !== void 0 ? _a : path.resolve(tmpApp, 'Contents', 'Resources', 'app.asar'));
            const arm64AsarSha = await sha((_b = opts.arm64AsarPath) !== null && _b !== void 0 ? _b : path.resolve(opts.arm64AppPath, 'Contents', 'Resources', 'app.asar'));
